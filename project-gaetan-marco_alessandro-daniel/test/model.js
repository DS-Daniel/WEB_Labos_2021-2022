...
import * as model from '../src/logic/model/entity.js';
...
describe('entity.js', () => {
  describe('The MovingEntity class should exists', () => {
    it('should exists', () => {
      assert.isTrue(model.Entity !== undefined);
    });
    it('The MovingEntity constructor should create a new object', () => {
      const e = new model.Entity(1, 100, 100, 100, 100, Math.PI);
      assert.equal(e.id, 1);
    ...
    it('The getMesh() method should raise an "Not implemented" error', () => {
      const e = new model.Entity(1, 100, 100, 100, 100, Math.PI);
      assert.throws(() => e.getMesh(), Error, 'Not implemented');
    });
  });
